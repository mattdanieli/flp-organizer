...
_translations: Dict[str, Dict[str, str]] = {
    ...
    "opt_color_tracks": {
        "en": "Auto-color clips (rainbow per group)",
        "de": "Clips automatisch einfärben (Regenbogen pro Gruppe)",
        "es": "Colorear clips automáticamente (arcoíris por grupo)",
        "fr": "Colorer automatiquement les clips (arc-en-ciel par groupe)",
        "it": "Colora clip automaticamente (arcobaleno per gruppo)",
        "ru": "Автораскраска клипов (радуга по группам)",
    },
    "opt_remove_empty": {
    ...
    "compat_errors_title": {
        "en": "Compatibility errors",
        "de": "Kompatibilitätsfehler",
        "es": "Errores de compatibilidad",
        "fr": "Erreurs de compatibilité",
        "it": "Errori di compatibilità",
        "ru": "Ошибки совместимости",
    },
    "compat_errors_prompt": {
        "en": "The validator detected serious problems with this .flp file:",
        "de": "Der Validator hat schwerwiegende Probleme erkannt:",
        "es": "El validador detectó problemas graves en el .flp:",
        "fr": "Le validateur a détecté des problèmes graves dans ce .flp :",
        "it": "Il validatore ha rilevato problemi gravi nel file .flp:",
        "ru": "Валидатор обнаружил серьёзные проблемы в .flp файле:",
    },
    "compat_errors_question": {
        "en": "Do you want to proceed anyway? (May corrupt the output)",
        "de": "Trotzdem fortfahren? (Kann die Ausgabe beschädigen)",
        "es": "¿Continuar de todos modos? (Puede dañar la salida)",
        "fr": "Continuer quand même ? (Peut corrompre la sortie)",
        "it": "Procedere comunque? (Può corrompere l'output)",
        "ru": "Продолжить всё равно? (Может повредить файл)",
    },
    "compat_blocked": {
        "en": "Apply blocked: compatibility errors detected.",
        "de": "Anwenden blockiert: Kompatibilitätsfehler erkannt.",
        "es": "Aplicar bloqueado: errores de compatibilidad detectados.",
        "fr": "Application bloquée : erreurs de compatibilité détectées.",
        "it": "Applica bloccato: errori di compatibilità rilevati.",
        "ru": "Применение заблокировано: ошибки совместимости.",
    },
    "compat_proceeding_warning": {
        "en": "Proceeding despite compatibility warnings — keep a backup.",
        "de": "Fortsetzung trotz Warnungen — Backup behalten.",
        "es": "Continuando a pesar de las advertencias — guarda un respaldo.",
        "fr": "Poursuite malgré les avertissements — gardez une sauvegarde.",
        "it": "Procedo nonostante gli avvisi — tieni un backup.",
        "ru": "Продолжаем несмотря на предупреждения — сохраните резервную копию.",
    },
    "compat_warnings_title": {
        "en": "Compatibility notes",
        "de": "Kompatibilitätshinweise",
        "es": "Notas de compatibilidad",
        "fr": "Remarques de compatibilité",
        "it": "Note di compatibilità",
        "ru": "Замечания о совместимости",
    },
    "compat_warnings_prompt": {
        "en": "Found a few things worth noting before processing:",
        "de": "Vor der Verarbeitung Folgendes beachten:",
        "es": "Algunos detalles a tener en cuenta antes de procesar:",
        "fr": "À noter avant de traiter :",
        "it": "Cose da sapere prima di procedere:",
        "ru": "Стоит обратить внимание перед обработкой:",
    },
    "compat_warnings_status": {
        "en": "Compatibility warnings — see notes above.",
        "de": "Kompatibilitätswarnungen — siehe Hinweise.",
        "es": "Advertencias de compatibilidad — ver notas.",
        "fr": "Avertissements de compatibilité — voir notes.",
        "it": "Avvisi di compatibilità — vedi note sopra.",
        "ru": "Предупреждения совместимости — см. выше.",
    },
    "write_failed": {
        "en": "Write failed.",
